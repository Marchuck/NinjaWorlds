 ...
 * @since 28.08.16.
 */
public class SnowFlakeEntity implements Entity {
    ...
    private final Entity.Random random;
    ...
    SnowFlakeEntity(Entity.Random random, Point position, float angle, float increment, float flakeSize, Paint paint) {
        this.random = random;
    ...
    public static SnowFlakeEntity create(int width, int height, Paint paint) {
        Entity.Random random = new Entity.Random();
        ...
        return new SnowFlakeEntity(random, position, angle, increment, flakeSize, paint);
    }
